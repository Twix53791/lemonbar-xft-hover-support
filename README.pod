...
will be execute when the mouse will enter the lemonbar window (set to "null" to disable it), when the second one will be executed when the mouse will leave the window.
